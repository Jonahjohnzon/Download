...
const baseURL =  "https://download.screenopps.com"
export const metadata = {
  ...
  title:{
    ...
    openGraph: {
      ...
      description: 'Screenopps offers download  links for movies and episodes that can be effortlessly integrated into your website through embed links, API, or WordPress plugins',
